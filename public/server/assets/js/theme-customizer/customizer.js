    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '../assets/images/logo/logo-2.png');

            ...
            <form action="#" class="checkout-form learts-mb-50">
                <div class="row">
                    <div class="col-md-6 col-12 learts-mb-20">
                        <label for="bdFirstName">Họ <abbr class="required">*</abbr></label>
                        <input type="text" id="bdFirstName">
                    </div>
                    <div class="col-md-6 col-12 learts-mb-20">
                        <label for="bdLastName">Tên <abbr class="required">*</abbr></label>
                    ...
                    <div class="col-12 learts-mb-20">
                        <label for="bdAddress1">Địa Chỉ <abbr class="required">*</abbr></label>
                    ...
                    <div class="col-12 learts-mb-20">
                        ...
                        <textarea id="ckeditor" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                    </div>
                </div>
            </form>
